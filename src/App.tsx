...
function ConnectionDetail({connectionId,onCharacter,onLocation,onEpisode,onConnection}:{connectionId:string;onCharacter:(id:string)=>void;onLocation:(l:Location)=>void;onEpisode:(id:string)=>void;onConnection:(id:string)=>void}){
 ...
 return <div className="contentScroll">
  ...
  <EntityGraphView heading="TRAVERSE THIS LINK" root={"connection:"+connectionId} onCharacter={onCharacter} onLocation={id=>{const l=atlasData.locations.find(x=>x.id===id);if(l)onLocation(l)}} onEpisode={onEpisode} onConnection={onConnection} onCommunity={id=>openPeopleEntity("community",id)} onFaction={id=>openPeopleEntity("faction",id)}/>
 </div>;
}
function EpisodeDetail({episode,onLocation,onEpisode,onCharacter,onConnection}:{episode:any;onLocation:(l:Location)=>void;onEpisode:(id:string)=>void;onCharacter:(id:string)=>void;onConnection:(id:string)=>void}){
 ...
 return <div className="contentScroll">
  ...
  <EntityGraphView heading="CONNECTIONS FROM HERE" root={"episode:"+episode.id} onCharacter={onCharacter} onLocation={id=>{const l=atlasData.locations.find(x=>x.id===id);if(l)onLocation(l)}} onEpisode={onEpisode} onConnection={onConnection} onCommunity={id=>openPeopleEntity("community",id)} onFaction={id=>openPeopleEntity("faction",id)}/>
 </div>;
}
...
function CharacterDetail({characterId,onEpisode,onLocation,onCharacter,onConnection,onJourney}:{characterId:string;onEpisode:(id:string)=>void;onLocation:(l:Location)=>void;onCharacter:(id:string)=>void;onConnection:(id:string)=>void;onJourney:()=>void}){
 ...
 return <div className="contentScroll">
  ...
  <EntityGraphView heading="CONNECTIONS FROM HERE" root={"character:"+characterId} onCharacter={onCharacter} onLocation={id=>{const l=atlasData.locations.find(x=>x.id===id);if(l)onLocation(l)}} onEpisode={onEpisode} onConnection={onConnection} onCommunity={id=>openPeopleEntity("community",id)} onFaction={id=>openPeopleEntity("faction",id)}/>
 </div>;
}
function PeopleContent({onCharacter,onLocation,onEpisode,onConnection,focusEntity:focusEntityProp}:{onCharacter:(id:string)=>void;onLocation:(id:string)=>void;onEpisode:(id:string)=>void;onConnection:(id:string)=>void;focusEntity?:string|null}){
 ...
 return <div className="contentScroll">
  ...
  <EntityGraphView heading="EXPLORE CONNECTIONS" onCharacter={onCharacter} onLocation={onLocation} onEpisode={onEpisode} onConnection={onConnection} onCommunity={id=>setFocusEntity("community:"+id)} onFaction={id=>setFocusEntity("faction:"+id)}/>
